        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                <div class="page-title">
                    <h1>{{ $breadcat->category_name }} Fashion</h1>
                </div>
                <!--Breadcrumbs-->
                <div class="breadcrumbs"><a href="{{ route('index') }}" title="Back to the home page">Home</a><span
                        class="title"><i class="icon anm anm-angle-right-l"></i>Shop</span><span class="main-title"><i
                            class="icon anm anm-angle-right-l"></i>{{ $breadcat->category_name }}</span></div>
                <!--End Breadcrumbs-->
            </div>
        </div>
    </div>
    ...
    <div class="collection-slider-6items gp10 slick-arrow-dots sub-collection section pt-0">
        ...
        @foreach ($subcats as $subcat)
            ...
            <div class="category-item zoomscal-hov">
                ...
                <a href="{{ url('subcategory-wise-product' . '/' . $subcat->id . '/' . $subcat->subcategory_slug) }}"
                    ...
                    <div
                        ...
                        <div class="filters-item d-flex align-items-center ms-2 ms-lg-3">
                            ...
                            <select name="SortBy" id="sortBy" class="filters-toolbar-sort">
                                ...
                                <option value="priceLowtoHigh" {{ $sort == 'priceLowtoHigh' ? 'selected' : '' }}>
                                    Price: Lower to
                                    Higher</option>
                                <option value="priceHightoLow" {{ $sort == 'priceHightoLow' ? 'selected' : '' }}>
                                    Price: Higher
                                    to Lower</option>
                                <option value="nameAtoZ" {{ $sort == 'nameAtoZ' ? 'selected' : '' }}>Product Name: A to
                                    Z
                                </option>
                                <option value="nameZtoA" {{ $sort == 'nameZtoA' ? 'selected' : '' }}>Product Name: Z to
                                    A
                                </option>
...
<script>
    $('#sortBy').change(function(e) {
        ...
        window.location = "{{ url('' . $route . '') }}/{{ $subCatId }}/{{ $subslug }}?sort=" +
            sortBy;
