                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="breadcrumbs"><a href="{{ route('index') }}"
                                    ...
                                    class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>Vendor
                                    Login</span>
                            </div>
                            <!--End Breadcrumbs-->
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                            <div class="inner h-100">
                                ...
                                <form method="post" action="{{ route('login') }}" class="customer-form">
                                    ...
                                    <h2 class="text-center fs-4 mb-3">Vendor Login</h2>
                                    ...
                                    <div class="login-signup-text mt-4 mb-2 fs-6 text-center text-muted">Don,t have an
                                        account? <a href="{{ route('vendor.register') }}" class="btn-link">Sign up
                                            now</a>
                                    </div>
                                </form>
