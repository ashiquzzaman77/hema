            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.profile') }}"><i
                                class="bx bx-user fs-5"></i><span>Profile</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center"
                            href="{{ route('vendor.change.password') }}"><i class="bx bx-cog fs-5"></i><span>Change
                                Password</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.logout') }}"><i
