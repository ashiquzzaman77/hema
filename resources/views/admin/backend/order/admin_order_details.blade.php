                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($order->status == 'pending')
                                                <a href="{{ route('admin.confirm.order', $order->id) }}"
                                                    class="badge bg-danger">Confirm Order</a>
                                            @elseif ($order->status == 'confirm')
                                                <a href="{{ route('admin.processing.order', $order->id) }}"
                                                    class="badge bg-warning">Processing Order</a>
                                            @elseif ($order->status == 'processing')
                                                <a href="{{ route('admin.deliver.order', $order->id) }}"
                                                    class="badge bg-success">Deliver Order</a>
                                            @endif
