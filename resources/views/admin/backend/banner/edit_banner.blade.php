                                ...
                                <form action="{{ route('update.banner') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input required autocomplete="off" type="text"
                                                    value="{{ $edit->sub_title }}" name="sub_title"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input required autocomplete="off" type="date"
                                                    value="{{ $edit->counter }}" name="counter"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <textarea class="form-control" name="descp" id="" cols="5" rows="5">{{ $edit->descp }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="submit" class="rounded-0 btn btn-dark px-3" value="Update Banner" />
                                            </div>
                                        </div>
