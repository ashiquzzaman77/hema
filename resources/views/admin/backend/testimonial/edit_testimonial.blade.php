                                ...
                                <form action="{{ route('update.testimonial') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input value="{{ $edit->position }}" required autocomplete="off" type="text" name="position"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <textarea name="description" class="form-control" id="" cols="5" rows="5">{{ $edit->description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="submit" class="rounded-0 btn btn-dark px-3" value="Update Category" />
                                            </div>
                                        </div>
